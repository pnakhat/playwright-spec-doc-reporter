## 🎭 Test Report — `feature/manual-test-results` · Run #67
commit `557f09fe`
...
> 🤖 **AI Analysis** (4 failures analysed) (98% confidence): The test intentionally attempts to assert visibility of a heading element with the text 'Non Existing Header', which does not exist in the DOM. The assertion fails after the 5000ms timeout because no  [View full analysis →](https://pnakhat.github.io/playwright-spec-doc-reporter/reports/pr-13/)

[📊 Full Report →](https://pnakhat.github.io/playwright-spec-doc-reporter/reports/pr-13/)