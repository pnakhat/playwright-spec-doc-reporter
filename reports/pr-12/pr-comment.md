## 🎭 Test Report — `feature/manual-test-results` · Run #64
commit `0127a2f3`
...
> 🤖 **AI Analysis** (4 failures analysed) (97% confidence): The test intentionally attempts to locate a heading element with the text 'Non Existing Header' that does not exist in the DOM, causing a toBeVisible assertion failure after the 5000ms timeout. [View full analysis →](https://pnakhat.github.io/playwright-spec-doc-reporter/reports/pr-12/)
