## 🎭 Test Report — `feature/auto-healing-pr-generation` · Run #82
commit `b223cf92`
...
> 🤖 **AI Analysis** (5 failures analysed) (98% confidence): The test 'broken selector always fails — dedup demo' intentionally uses a non-existent CSS selector '#this-element-does-not-exist' and asserts it is visible, causing a guaranteed and deterministic fai [View full analysis →](https://pnakhat.github.io/playwright-spec-doc-reporter/reports/pr-17/)

[📊 Full Report →](https://pnakhat.github.io/playwright-spec-doc-reporter/reports/pr-17/)