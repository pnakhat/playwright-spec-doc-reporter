## 🎭 Test Report — `autofix/tests-ui-saucedemo-spec-js-2026-03-24T11-16-47` · Run #69
commit `ab044502`
...
> 🤖 **AI Analysis** (4 failures analysed) (98% confidence): The test intentionally attempts to assert visibility of a heading element with the text 'Non Existing Header', which does not exist in the DOM. The assertion fails after the 5000ms timeout because no  [View full analysis →](https://pnakhat.github.io/playwright-spec-doc-reporter/reports/pr-14/)

[📊 Full Report →](https://pnakhat.github.io/playwright-spec-doc-reporter/reports/pr-14/)